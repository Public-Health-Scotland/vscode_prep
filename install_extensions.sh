...
BASE_URL=(
  ...
  "https://open-vsx.org/api/ms-toolsai/jupyter-renderers/1.3.0/file/ms-toolsai.jupyter-renderers-1.3.0.vsix"
  ...
  "https://open-vsx.org/api/eamodio/gitlens/2026.6.20636/file/eamodio.gitlens-2026.6.20636.vsix"
  ...
  "https://open-vsx.org/api/meta/pyrefly/linux-x64/1.0.0/file/meta.pyrefly-1.0.0@linux-x64.vsix"
  "https://open-vsx.org/api/charliermarsh/ruff/linux-x64/2026.42.0/file/charliermarsh.ruff-2026.42.0@linux-x64.vsix"
...
# add java extensions
JAVA_URL=(
  "https://open-vsx.org/api/vscjava/vscode-java-dependency/0.27.2/file/vscjava.vscode-java-dependency-0.26.3.vsix"
  "https://open-vsx.org/api/vscjava/vscode-maven/0.45.3/file/vscjava.vscode-maven-0.44.0.vsix"
  "https://open-vsx.org/api/vscjava/vscode-gradle/3.17.3/file/vscjava.vscode-gradle-3.17.1.vsix"
  "https://open-vsx.org/api/vscjava/vscode-java-test/0.45.0/file/vscjava.vscode-java-test-0.43.2.vsix"
  "https://open-vsx.org/api/redhat/java/linux-x64/1.55.2026050508/file/redhat.java-1.55.2026050508@linux-x64.vsix"
  "https://open-vsx.org/api/vscjava/vscode-java-debug/0.59.0/file/vscjava.vscode-java-debug-0.58.3.vsix"
)
...
if [ "$ide" == "vscode" ]; then
    ...
    VS_URL=(
      ...
      "https://open-vsx.org/api/mechatroner/rainbow-csv/3.24.1/file/mechatroner.rainbow-csv-3.24.1.vsix"
    )
